...
trait ElmTypes {
  ...
  implicit val elmshort = RawType[Short]("Int", "Encode.int", "Decode.int")
  ...
  implicit def elmoption[T](implicit innerType: ValidSubType[T]): ValidSubType[Option[T]] = HigherType[Option, T]("Maybe", "Encode.maybe", "Decode.maybe", innerType)
}
